...
# İklim verilerini JSON dosyasından yükleme fonksiyonu (Orijinal Basit Yapı)
...
# İlçe listesini al (Merkez ilçe sözlükte ilk sırada tanımlı olduğu için index=0 otomatik seçilir)
ilceler_listesi = sorted(list(iklim_veritabani[secilen_il].keys()))
secilen_ilce = st.selectbox("İlçe seçin:", ilceler_listesi, index=0)
